...
const List = () => {
  ...
  useEffect(() => {
    ...
    // If no destination is specified, show all hotels
    if (!destination) {
        ...
        <div className="listWrapper">
          <div className="listSearch">
            <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
              <h1 className="lsTitle">Filter Results</h1>
              ...
              <button onClick={handleClick} id="search-button">Search Results</button>
            </div>
          </div>
              ...
              <>
                {filteredData.length > 0 && (
                  <div className="resultsSummary">
                    Found {filteredData.length} {filteredData.length === 1 ? 'hotel' : 'hotels'}
